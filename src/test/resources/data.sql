...
INSERT INTO `guests` (`full_name`, `address`, `contact_number`, `email`) 
VALUES ('Test Guest', '123 Test St', '0771234567', 'test@test.com');
...
INSERT INTO `users` (`username`, `password_hash`, `role`, `status`) 
VALUES ('testadmin', 'hashedpassword123', 'ADMIN', 'ACTIVE');
